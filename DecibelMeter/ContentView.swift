...
final class AudioMeter: ObservableObject {
    @Published var calibrationOffset: Float = 7.0 // Default value set to +7.0 based on user feedback
...
struct ContentView: View {
    ...
    @State private var calibrationOffsetValue: Float = 7.0 // Default set to +7.0 based on user feedback
